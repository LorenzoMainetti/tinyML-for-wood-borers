...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mtl_model"
...
#define AI_NETWORK_IN_1_HEIGHT      (2205)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (2205 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (2205)
...
#define AI_NETWORK_OUT_1_SIZE_BYTES  (1)
#define AI_NETWORK_OUT_2_CHANNEL     (3)
#define AI_NETWORK_OUT_2_SIZE        (3)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (3)

/******************************************************************************/
#define AI_NETWORK_N_NODES (18)
