...
{
#if defined(HAS_DEDICATED_PERF_COUNTER) && HAS_DEDICATED_PERF_COUNTER == 1
	PERF_COUNTER_INIT();
	cyclesCount.tick_start = 0;
#else
#if USE_SYSTICK_ONLY == 1
...
{
#if defined(HAS_DEDICATED_PERF_COUNTER) && HAS_DEDICATED_PERF_COUNTER == 1
	cyclesCount.tick_start = PERF_COUNTER_GET();
#else
#if USE_SYSTICK_ONLY == 1
  cyclesCount.tick_start = HAL_GetTick();
  cyclesCount.count_start = SysTick->VAL;
...
{
#if defined(HAS_DEDICATED_PERF_COUNTER) && HAS_DEDICATED_PERF_COUNTER == 1
	return PERF_COUNTER_GET() - cyclesCount.tick_start;
#else
#if USE_SYSTICK_ONLY == 1
