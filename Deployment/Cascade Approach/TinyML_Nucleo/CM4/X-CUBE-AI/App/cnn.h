...
#define AI_CNN_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_CNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_CNN_IN \
  ai_cnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_IN_SIZE { \
  AI_CNN_IN_1_SIZE, \
}
#define AI_CNN_IN_SIZE_BYTES { \
  AI_CNN_IN_1_SIZE_BYTES, \
}
#define AI_CNN_IN_1_HEIGHT      (39)
#define AI_CNN_IN_1_WIDTH       (33)
#define AI_CNN_IN_1_CHANNEL     (1)
#define AI_CNN_IN_1_SIZE        (39 * 33 * 1)
#define AI_CNN_IN_1_SIZE_BYTES  (1287)
...
AI_DEPRECATED
#define AI_CNN_OUT \
  ai_cnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_OUT_SIZE { \
  AI_CNN_OUT_1_SIZE, \
}
#define AI_CNN_OUT_SIZE_BYTES { \
  AI_CNN_OUT_1_SIZE_BYTES, \
}
#define AI_CNN_OUT_1_CHANNEL     (3)
#define AI_CNN_OUT_1_SIZE        (3)
#define AI_CNN_OUT_1_SIZE_BYTES  (3)

/******************************************************************************/
#define AI_CNN_N_NODES (11)
 ...
 * @ref ai_cnn_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_CNN_*
 * defines into file @ref cnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
